...
type CheckerSpec_Type int32

const (
	CheckerSpec_Index    CheckerSpec_Type = 0
	CheckerSpec_Validity CheckerSpec_Type = 1
)

var CheckerSpec_Type_name = map[int32]string{
	0: "Index",
	1: "Validity",
}
var CheckerSpec_Type_value = map[string]int32{
	"Index":    0,
	"Validity": 1,
}

func (x CheckerSpec_Type) Enum() *CheckerSpec_Type {
	p := new(CheckerSpec_Type)
	*p = x
	return p
}
func (x CheckerSpec_Type) String() string {
	return proto.EnumName(CheckerSpec_Type_name, int32(x))
}
func (x *CheckerSpec_Type) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(CheckerSpec_Type_value, data, "CheckerSpec_Type")
	if err != nil {
		return err
	}
	*x = CheckerSpec_Type(value)
	return nil
}
func (CheckerSpec_Type) EnumDescriptor() ([]byte, []int) {
...
type ProcessorCoreUnion struct {
	...
	Checker     *CheckerSpec        `protobuf:"bytes,15,opt,name=checker" json:"checker,omitempty"`
}
...
// CheckerSpec is the specification for a database check.
type CheckerSpec struct {
	Type  CheckerSpec_Type                       `protobuf:"varint,1,opt,name=type,enum=cockroach.sql.distsqlrun.CheckerSpec_Type" json:"type"`
	Table cockroach_sql_sqlbase1.TableDescriptor `protobuf:"bytes,2,opt,name=table" json:"table"`
	// Sections of the table to be backfilled.
	Spans []TableReaderSpan `protobuf:"bytes,3,rep,name=spans" json:"spans"`
	// The backfill involves a complete table scan in chunks,
...
func (m *CheckerSpec) Reset()                    { *m = CheckerSpec{} }
func (m *CheckerSpec) String() string            { return proto.CompactTextString(m) }
func (*CheckerSpec) ProtoMessage()               {}
func (*CheckerSpec) Descriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{14} }
...
func (*FlowSpec) Descriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{15} }
...
func (*AlgebraicSetOpSpec) Descriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{16} }
...
func init() {
	...
	proto.RegisterType((*CheckerSpec)(nil), "cockroach.sql.distsqlrun.CheckerSpec")
	...
	proto.RegisterEnum("cockroach.sql.distsqlrun.CheckerSpec_Type", CheckerSpec_Type_name, CheckerSpec_Type_value)
...
func (m *ProcessorCoreUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Checker != nil {
		dAtA[i] = 0x7a
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(m.Checker.Size()))
		n19, err := m.Checker.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
...
func (m *CheckerSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CheckerSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ProcessorCoreUnion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			...
			if m.Checker == nil {
				m.Checker = &CheckerSpec{}
			}
			if err := m.Checker.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CheckerSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CheckerSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CheckerSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= (CheckerSpec_Type(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorProcessors = []byte{
	...
	,
}
